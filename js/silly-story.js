...
function result() {
    ...
    var customName = document.getElementById('customname').value;  // Get the value from the customName input field

    // If the user has entered a name, replace "Bob" with the custom name
    if(customName !== "") {
